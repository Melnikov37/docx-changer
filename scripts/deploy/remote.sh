...
if [ -n "$SECRET_KEY" ]; then
    ...
    # SSL paths (default to Let's Encrypt if not specified)
    SSL_CERT="${SSL_CERT_PATH:-/etc/letsencrypt/live/docxfiller.ru/fullchain.pem}"
    SSL_KEY="${SSL_KEY_PATH:-/etc/letsencrypt/live/docxfiller.ru/privkey.pem}"
